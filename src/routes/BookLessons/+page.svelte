...
<div id="booking">
	<form id="contact">
		<fieldset id="ContactForm">
			...
			<i class="fa-solid fa-id-card" style="color: #daa520;" />
			...
			<i class="fa-solid fa-mobile-screen-button" style="color: #daa520;" />
			<label for="PhoneNumber">Phone Number</label>
			<input type="tel" id="PhoneNumber" autocomplete="tel" />
			<br />
			<i class="fa-regular fa-envelope" style="color: #daa520;" />
		...
		<fieldset id="ContactMethod">
			...
			<i class="fa-brands fa-whatsapp" style="color: #daa520;" />
	...
	<div
		...
		data-url="https://calendly.com/melissageoghegan95?hide_gdpr_banner=1&primary_color=daa520"
		style="min-width:320px;height:505px;"
	/>
</div>
{#if browser}
